    ...
    async def authenticate(self, handler, data):
        ...
        try:
            ...
            if e.log_message:
                ...
                error_msg = urllib.parse.quote(f"Error {e}".encode('utf-8')) + ". Please login to access Clowder."
...
class CustomTokenLogoutHandler(LogoutHandler):
    ...
    async def handle_logout(self):
        ...
        error_msg = "You have logged out of Clowder system from Clowder . Please login again if you want to use " \
                    "Clowder components."
