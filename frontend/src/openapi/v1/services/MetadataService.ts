...
export class MetadataService {
	 ...
	 * @throws ApiError
	 */
	public static deleteMetadata(id: string): CancelablePromise<any> {
		return __request({
			method: "DELETE",
	 ...
	 * @throws ApiError
	 */
	public static getMetadata(filter: string): CancelablePromise<any> {
		return __request({
			method: "GET",
	 ...
	 * @throws ApiError
	 */
	public static getMetadata3(id: string): CancelablePromise<any> {
		return __request({
			method: "GET",
	 ...
	 * @throws ApiError
	 */
	public static getMetadata5(id: string): CancelablePromise<any> {
		return __request({
			method: "GET",
	 ...
	 * @throws ApiError
	 */
	public static deleteMetadata1(id: string): CancelablePromise<any> {
		return __request({
			method: "DELETE",
			path: `/standardvocab/${id}`,
		});
	 ...
	 * @throws ApiError
	 */
	public static getMetadata6(id: string): CancelablePromise<any> {
		return __request({
			method: "GET",
