...
export class CurationsService {
	 ...
	 * @throws ApiError
	 */
	public static postCurations(id: string): CancelablePromise<any> {
		return __request({
			method: "POST",
	 ...
	 * @throws ApiError
	 */
	public static deleteCurations(id: string): CancelablePromise<any> {
		return __request({
			method: "DELETE",
	 ...
	 * @throws ApiError
	 */
	public static getCurations(id: string): CancelablePromise<any> {
		return __request({
			method: "GET",
	 ...
	 * @throws ApiError
	 */
	public static getCurations1(curationId: string): CancelablePromise<any> {
		return __request({
			method: "GET",
