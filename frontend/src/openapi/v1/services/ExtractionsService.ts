...
export class ExtractionsService {
	 ...
	 * @throws ApiError
	 */
	public static getExtractions3(id: string): CancelablePromise<any> {
		return __request({
			method: "GET",
	 ...
	 * @throws ApiError
	 */
	public static getExtractions5(id: string): CancelablePromise<any> {
		return __request({
			method: "GET",
	 ...
	 * @throws ApiError
	 */
	public static getExtractions7(id: string): CancelablePromise<any> {
		return __request({
			method: "GET",
