...
export class SectionService {
	 ...
	 * @throws ApiError
	 */
	public static postSection(requestBody: {
		file_id: string;
	 ...
	 * @throws ApiError
	 */
	public static getSection(id: string): CancelablePromise<any> {
		return __request({
			method: "GET",
			path: `/sections/${id}`,
		});
	 ...
	 * @throws ApiError
	 */
	public static deleteSection(id: string): CancelablePromise<any> {
		return __request({
			method: "DELETE",
			path: `/sections/${id}`,
		});
	 ...
	 * @throws ApiError
	 */
	public static getSection1(id: string): CancelablePromise<any> {
		return __request({
			method: "GET",
	 ...
	 * @throws ApiError
	 */
	public static deleteSection1(id: string): CancelablePromise<any> {
		return __request({
			method: "DELETE",
			path: `/sections/${id}/tags`,
		});
	 ...
	 * @throws ApiError
	 */
	public static postSection5(id: string): CancelablePromise<any> {
		return __request({
			method: "POST",
	 ...
	 * @throws ApiError
	 */
	public static postSection6(id: string): CancelablePromise<any> {
		return __request({
			method: "POST",
