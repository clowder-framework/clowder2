...
export class LogosService {
	 ...
	 * @throws ApiError
	 */
	public static getLogos1(id: string): CancelablePromise<any> {
		return __request({
			method: "GET",
			path: `/logos/${id}`,
		});
	 ...
	 * @throws ApiError
	 */
	public static putLogos(id: string): CancelablePromise<any> {
		return __request({
			method: "PUT",
			path: `/logos/${id}`,
		});
	 ...
	 * @throws ApiError
	 */
	public static deleteLogos(id: string): CancelablePromise<any> {
		return __request({
			method: "DELETE",
			path: `/logos/${id}`,
		});
	 ...
	 * @throws ApiError
	 */
	public static getLogos2(id: string): CancelablePromise<any> {
		return __request({
			method: "GET",
			path: `/logos/${id}/blob`,
		});
	 ...
	 * @throws ApiError
	 */
	public static getLogos3(path: string, name: string): CancelablePromise<any> {
		return __request({
			method: "GET",
	 ...
	 * @throws ApiError
	 */
	public static putLogos1(path: string, name: string): CancelablePromise<any> {
		return __request({
			method: "PUT",
			path: `/logos/${path}/${name}`,
		});
	 ...
	 * @throws ApiError
	 */
	public static getLogos4(path: string, name: string): CancelablePromise<any> {
		return __request({
			method: "GET",
