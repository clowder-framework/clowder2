...
/* tslint:disable */
/* eslint-disable */
import type { EventListenerJobDB } from '../models/EventListenerJobDB';
...
export class JobsService {
     ...
     * @param skip
     * @param limit
     * @returns EventListenerJobDB Successful Response
     * @throws ApiError
     */
    public static getAllJobSummaryApiV2JobsGet(
        ...
        skip?: number,
        limit: number = 2,
    ): CancelablePromise<Array<EventListenerJobDB>> {
        return __request({
            method: 'GET',
            path: `/api/v2/jobs`,
            query: {
    ...
    public static getJobSummaryApiV2JobsJobIdSummaryGet(
        jobId: string,
    ): CancelablePromise<EventListenerJobDB> {
        return __request({
            method: 'GET',
